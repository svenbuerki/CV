...
```{r, results='asis'}
intro_text <- glue("Assistant Professor, Department of Biological Sciences at Boise State University. My lab applies a genome-to-phenome approach to investigate mechanisms of drought adaptations in natural ecosystems. We are currently focusing our efforts on the sagebrush steppe of western North America by using *Artemisia tridentata* as model organism. This research is integrated into the [EPSCoR NSF GEM3](https://www.idahogem3.org) project. 
...
glue(
  " 
  **Contributions to describing plant biodiversity:**
  i) Newly described taxa: 1 family, 4 genera, 3 sections, and 33 species; ii) New names: 1 species and iii) New combinations: 114 species, and 1 subspecies.
  "
) %>% print()
```
...
glue(
  " 
  As part of a botanical expedition in the Ambohimirahavavy region (Madagascar) I collected a specimen of Meliaceae, which turned out to represent a new species. My friends were very kind and dedicated this new species to me and my family: _**Turraea buerkii**_ Callm., Phillipson & Lowry, *Adansonia*, *sér.* 3, 34(1): 100. 2012.
  "
) %>% print()
```
